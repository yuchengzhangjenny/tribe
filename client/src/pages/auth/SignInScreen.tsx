...
const SignInScreen = ({ navigation }: any) => {
  ...
  const handleSignIn = async () => {
    ...
    try {
      ...
      // After successful sign-in, navigate to Registration flow
      Alert.alert(
        'Success', 
        ...
        [
          {
            ...
            onPress: () => {
              ...
              // - Set hasCompletedRegistration: false (if this is a new user)
              
              // Then navigation would automatically go to Registration flow
              // For development, we'll forcefully navigate to the root and 
              // the app will show the Registration flow because we set
              // isAuthenticated = true and hasCompletedRegistration = false
              navigation.reset({
                index: 0,
